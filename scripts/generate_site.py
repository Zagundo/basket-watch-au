...
<div class="container">
  ...
  <div style="margin-bottom:1.5rem;">
    <h2 style="margin-bottom:0.75rem;">More baskets</h2>
    <div style="display:flex;gap:0.75rem;flex-wrap:wrap;">
      <a href="crest.html" style="display:inline-block;background:#fff;border:1px solid #dee2e6;border-radius:10px;padding:0.85rem 1.25rem;text-decoration:none;color:#212529;font-weight:600;font-size:0.9rem;">🧺 CREST Family Basket <span style="font-size:0.78rem;color:#6c757d;font-weight:400;">— 15 items × 5 shopper segments</span></a>
      <a href="bolognese.html" style="display:inline-block;background:#fff;border:1px solid #dee2e6;border-radius:10px;padding:0.85rem 1.25rem;text-decoration:none;color:#212529;font-weight:600;font-size:0.9rem;">🍝 Spaghetti Bolognese <span style="font-size:0.78rem;color:#6c757d;font-weight:400;">— Traditional vs Saver</span></a>
    </div>
  </div>
